...
/**
 *Classe que representa la instància d'un dih4cat.item, format pel seu ID i els seus atributs
 */
...
public class Item {
    ...
    /**
     * COntructora de la classe dih4cat.item
     *
     * @param id         ID que se li assignara al dih4cat.item
     * @param attributes Array dels atributs de l'dih4cat.item
     ...
     *
     * @return Nombre d'atributs del dih4cat.item
     * Complexitat O(1)
     */
