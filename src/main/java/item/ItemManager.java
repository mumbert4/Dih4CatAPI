...
public class ItemManager {
    ...
    public Item getItem(int i){// retorna un item segons el seu ID
        return items.get(i);
    }
    ...
    public void createColumns(List<String> listItems) {
        ...
        for (int i = 1; i < listItems.size(); ++i) {// començam a 1 perque la 0 no ens importa
            ...
            HashMap<String,Column> prop = new HashMap<>();//hash map de les propietats de cada item
            String modality = "";
            String organizer ="";
            String status = "";
            double duration = 0;
    ...
    public void showItems(){
        ...
        for(Item it: items.values()){
            System.out.println("Estam a l'item: " + i);
            for(String s: cols){
